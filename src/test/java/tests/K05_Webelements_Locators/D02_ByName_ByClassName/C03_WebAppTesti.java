...
public class C03_WebAppTesti {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //4. Resim altinda 6 islem basligi oldugunu teyit edin
        ...
        /*
            2. yontem : Bos bir String list olusturup
                        for loop ile webelementler uzerindeki yazilari alip
                        String list'e ekleriz
                        Sonra o String list'te aranan basligin olup olmadigini test ederiz
         */
